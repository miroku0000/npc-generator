...
if __name__ == "__main__":
    ...
    while True:
        ...
        if result_directory:
            ...
            command = f'venv\\Scripts\\activate venv && python generatenpc.py --npcgender {gender} --npcrace {race} --npcclass "{job}" --imagesperscenario 1 --scenarios 20 --steps 32 --width 256 --height 256'
